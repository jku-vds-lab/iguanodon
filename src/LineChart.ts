...
import { addBackgroundColor, addLegend, colorEncoding, designChoiceBase, nominalColorScale, sampleData, startWith0YAxis, xAxisEncoding, yAxisEncoding } from "./designChoices";
